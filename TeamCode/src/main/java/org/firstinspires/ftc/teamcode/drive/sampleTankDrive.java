...
public class sampleTankDrive extends TankDrive {
    ...
    public sampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx left = hardwareMap.get(DcMotorEx.class, "motorLeft");
        DcMotorEx right = hardwareMap.get(DcMotorEx.class, "motorRight");
    ...
    public <Trajectory> void followTrajectory(Trajectory forwardTrajectory) {
    }
}
